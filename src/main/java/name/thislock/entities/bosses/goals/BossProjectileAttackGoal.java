...
public class BossProjectileAttackGoal extends Goal {
    ...
    public BossProjectileAttackGoal(RangedAttackMob mob, double mobSpeed, int intervalTicks, float minShootRange, float maxShootRange) {
        this(mob, mobSpeed, intervalTicks, intervalTicks, minShootRange, maxShootRange);
    }

    public BossProjectileAttackGoal(RangedAttackMob mob, double mobSpeed, int minIntervalTicks, int maxIntervalTicks, float minShootRange, float maxShootRange) {

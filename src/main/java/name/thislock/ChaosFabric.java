...
public class ChaosFabric implements ModInitializer {
	public static final String MOD_ID = "chaosfabric";
	...
	public void onInitialize() {
		...
		ChaosFabricItems.initialize();
		BossInitializer.initialize();

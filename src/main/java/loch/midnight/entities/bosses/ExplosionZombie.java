...
import loch.midnight.entities.bosses.goals.BossAttackGoal;
import loch.midnight.entities.bosses.goals.BossFleeGoal;
import loch.midnight.entities.bosses.goals.ExplosivePunchGoal;
import loch.midnight.entities.bosses.goals.ExplosivePunchWarningGoal;
...
public class ExplosionZombie extends Boss {
    ...
    public void createBossDrops(ServerWorld world) {
        for (int i = 0; i < random.nextBetween(50, 200); ++i)
            this.dropItem(world, MidnightItems.DYNAMITE_GLOVE);
    }
